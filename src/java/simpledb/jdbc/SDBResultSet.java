...
public class SDBResultSet implements ResultSet {
    ...
    private List<Tuple> rawRS;
    private int counter;
    private boolean closed;

    public SDBResultSet(List<Tuple> rawRS) {
        this.rawRS = rawRS;
        closed = false;
    }
    ...
    public String getString(int columnIndex) throws SQLException {
        Field field = rawRS.get(counter).getField(columnIndex);
        if (field.getType() == Type.STRING_TYPE) {
            StringField stringField = (StringField) field;
            return stringField.getValue();
        } else
            throw new SQLException(String.format("%d is not String Type", columnIndex));

    }

    @Override
    public boolean getBoolean(int columnIndex) throws SQLException {
        return Boolean.getBoolean(getString(columnIndex));
    }
    ...
    public int getInt(int columnIndex) throws SQLException {
        ...
        if (field.getType() == Type.INT_TYPE) {
            ...
            throw new SQLException(String.format("%d is not INT Type", columnIndex));
    }
